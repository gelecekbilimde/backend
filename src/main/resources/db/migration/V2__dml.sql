...
values ('836e0a9c-b2bb-4ecf-bf8b-870ea7bb8bc7', 'Yönetici Paneline Erişir', 'panel:admin',
...
values ('35bc91b4-3b92-4ff5-b204-439ef21d2d94', 'Gönderisini Siler', 'post:delete',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
values ('01bc1089-bd27-4b41-bfde-8e63c988fec3', 'Gönderi Beğenir', 'post:like',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
...
values ('f8217f8d-8d67-496f-8761-53201e690078', 'Profil Düzenler', 'profile:edit',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
values ('0352ee79-e844-4e91-968f-c9f3e4a27515', 'Rol Başvurularını Listeler', 'role:application:list',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
values ('31366d9d-5282-4fe2-9d45-4551e114bc7d', 'Rol Başvurusunu Sonuçlandırır', 'role:application:conclude',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
values ('edfb8180-92ef-4a9e-8913-1bdfa606d297', 'Yazar Olmak İçin Başvuru Oluşturur', 'role:application:create:author',
        false, 'gelecekbilimde', current_timestamp);
insert into gb_permission (id, description, name, is_hidden, created_by, created_at)
values ('171ca9a7-311d-40b6-b538-024b5870471a', 'Moderatör Olmak İçin Başvuru Oluşturur',
        'role:application:create:moderator',
        false, 'gelecekbilimde', current_timestamp);
